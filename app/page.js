...
export default function HomePage() {
  return <>
    <section className="salon-hero salon-wrap">
      ...
      <figure className="salon-hero-image"><img src="/gallery/studio-interior.jpg" alt="Salon Poke Bristol studio interior" /></figure>
    </section>
